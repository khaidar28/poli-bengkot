...
<form class="form row" method="POST" action="" name="myForm" onsubmit="return(validate());">
     ...
     <div class="row">
          <div class="col-sm-12">
               ...
               <input type="text" class="form-control" name="nama_obat" id="nama_obat" placeholder="Nama" value="<?php echo $nama_obat ?>">
          </div>
          <div class="col-sm-12">
          ...
          <div class="col-sm-12 mb-2">
               ...
               <input type="text" class="form-control" name="harga" id="harga" placeholder="No hp " value="<?php echo $harga ?>">
          </div>
          <div class="col">
